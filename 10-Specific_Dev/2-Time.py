...
print(time.localtime()) # localtime crée un objet représentant le temps.
"""
...
temps = time.time()
ts_temps = time.localtime(temps)
print(temps)
print(time.mktime(ts_temps))
...
# exempre d'utilistation de timedelta 
